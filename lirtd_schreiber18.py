...
read_file_data_min_z = '../data/schreiber18_fit_max_z_best_fit_params_added.pkl'
fitF_max_z = pd.read_pickle(read_file_data_min_z)
...
plt.scatter(10**fitF_max_z.measuredLIR, fitF_max_z.measuredLPeak, marker='.', color='b', alpha=0.7, label='schreiber+18 max z')
